...
UNIFIED_VCF_FILE_PATH="/data2/GUPPY5/OUTPUT_UNI/chr20/HG002/unified.vcf.gz"       # e.g. hg002.unified.vcf.gz
ALL_BAM_FILE_PATH="/data2/GUPPY5/chr20/hg002_chr20.bam"           # e.g. hg002.bam
DEPTHS="1000"                  # e.g. 1000 (means no subsample)
ALL_REFERENCE_FILE_PATH="/work/Clair3-Trio-trio/data/clair3_trio_quick_demo/GRCh38_no_alt_chr20.fa"   # e.g. hg002.fasta
ALL_BED_FILE_PATH="/work/Clair3-Trio-trio/data/clair3_trio_quick_demo/HG002_GRCh38_20_v4.2.1_benchmark_noinconsistent.bed"           # e.g. hg002.bed
ALL_SAMPLE="GRCh38"                    # e.g. hg002
OUTPUT_DIR="/data2/attdeepcaller/data/GUPPY5-trainoutput/pileup/modeltest-chr20"                   # e.g. output_folder
...
## pls note that in the pretrained models, we have excluded chr20 as a hold-out set.
CHR=(20)
