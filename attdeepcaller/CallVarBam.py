...
def Run(args):
    ...
    RR_Bin = basedir + "/../attdeepcaller.py RealignReads"
    CVBin = basedir + "/../attdeepcaller.py CallVariants"
...
def main():
    ...
    ## Use attdeepcaller's own phasing module for read level phasing when creating tensor, compared to using Whatshap, speed is faster but has higher memory footprint, default: False
