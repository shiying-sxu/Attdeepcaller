...
DEEP_LEARNING_FOLDER="attdeepcaller"
POST_PROCESS_SCRIPTS_FOLDER="attdeepcaller.metrics"
...
def print_help_messages():
    ...
    print(dedent("""\
        {0} submodule invocator:
            Usage: python attdeepcaller.py [submodule] [options of the submodule]
...
def main():
    ...
    # filter arguments (i.e. filter attdeepcaller.py) and add ".py" for that submodule
    sys.argv = sys.argv[1:]
    sys.argv[0] += (".py")
